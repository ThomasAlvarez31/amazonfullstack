...
function subtotal(): number { return items.reduce((s, i) => s + i.unitPrice * i.quantity, 0) }
function shipping(): number { return subtotal() > 50000 ? 0 : 4990 }
function total():    number { return subtotal() + shipping() }
